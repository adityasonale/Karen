# -*- coding: utf-8 -*-
"""non_functional.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZtVn-jcYd6xGxY7CI3qqwzJyFKgv1OWL
"""
...
df.to_csv(r'D:\vs code\python\DeepLearning\Projects\Karen\v2\Datasets\non_functional\chatbot_dataset_non_functional.csv',index=False)

dataset = pd.read_csv(r'D:\vs code\python\DeepLearning\Projects\Karen\v2\Datasets\non_functional\chatbot_dataset_non_functional.csv')
...
df.to_csv(r'D:\vs code\python\DeepLearning\Projects\Karen\v2\Datasets\non_functional\chatbot_dataset_non_functional_cleaned.csv',index=False)
...
with open(r"D:\vs code\python\DeepLearning\Projects\Karen\v2\Pickles\non_functional\padding_length_non_functional.pickle",'wb') as file:
...
with open(r'D:\vs code\python\DeepLearning\Projects\Karen\v2\Pickles\non_functional\my_dict_non_functional.pickle', 'wb') as file:
    pickle.dump(embeddings_dictionary, file)
    file.close()

with open(r'D:\vs code\python\DeepLearning\Projects\Karen\v2\Pickles\non_functional\my_tokenizer_non_functional.pickle','wb') as file:
...
history = modelNN.fit(padded_sentences, y, batch_size=32, epochs=200, verbose=1, validation_split=0.2)

modelNN.save(r"D:\vs code\python\DeepLearning\Projects\Karen\v2\models\cb2_non_functional.h5")